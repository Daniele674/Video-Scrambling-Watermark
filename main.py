...
video_input_path = 'testSet/doppio.mp4'
...
sc.scramblevideo_parallel(video_input_path, video_scrambled_path, scramble_settings, key)
...
sc.descramblevideo_parallel(video_scrambled_path, video_descrambled_path, key)
